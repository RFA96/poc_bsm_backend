...
ScoringRepository.prototype = {
    ...
    save: function (scoring, cb, errCb) {
        ...
        let query = "INSERT INTO public.scoring(id_scoring, ip_address, scoring_results, created_datetime, id_user) VALUES('" + scoring.id_scoring + "', '" + scoring.ip_address + "', '" + scoring.scoring_results+ "', '" +date + "', '" + scoring.id_user + "');";
